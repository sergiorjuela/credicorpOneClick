...
public class OCActivoInformacion implements ElementInDiagram {
	...
	/* MetaAttributes */
	public static final String MA_OCActivoUso = "~ZBa1rSGqQH0C[X]";
	public static final String MAV_OCActivoUso_OCActivoUAlto = "4";
	public static final String MAV_OCActivoUso_OCActivoUMuyAlto = "5";
	public static final String MAV_OCActivoUso_OCActivoUMedio = "3";
	public static final String MAV_OCActivoUso_OCActivoUBajo = "2";
	public static final String MAV_OCActivoUso_OCActivoUMuyBajo = "1";
	public static final String MA_OCRiesgoActivo = "~k8a1ghGqQLfC[X]";
	public static final String MAV_OCRiesgoActivo_OCActivoRAMuyAlto = "5";
	public static final String MAV_OCRiesgoActivo_OCActivoRAAlto = "4";
	public static final String MAV_OCRiesgoActivo_OCActivoRAMedio = "3";
	public static final String MAV_OCRiesgoActivo_OCActivoRABajo = "2";
	public static final String MAV_OCRiesgoActivo_OCActionRAMuyBajo = "1";
	...
	public static final String MAV_OCActivoRepudio_OCActivoRMuyBajo = "1";
	public static final String MAV_OCActivoRepudio_OCActivoRBajo = "2";
	public static final String MAV_OCActivoRepudio_OCActivoRMedio = "3";
	public static final String MAV_OCActivoRepudio_OCActivoRAlto = "4";
	public static final String MAV_OCActivoRepudio_OCActivoRMuyAlto = "5";
